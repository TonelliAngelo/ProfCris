...
window.profacrisAnalyticsAllowed = analyticsGranted;
...
const updateAnalyticsConsent = (value, sendPageView = false) => {
...
const loadGoogleTag = () => {
  if (document.querySelector(
    `script[data-ga-id="${PROFACRIS_GA_ID}"]`
  )) return;
  ...
  script.async = true;
  script.src =
    `https://www.googletagmanager.com/gtag/js?id=${PROFACRIS_GA_ID}`;
...
const buildConsentBanner = () => {
  ...
  text.textContent =
    "Usamos métricas opcionais para entender como o site é utilizado e melhorar a experiência. Sem o aceite, não usamos cookies de análise nem armazenamos identificadores no dispositivo; o Google poderá receber apenas sinais técnicos limitados.";

  essentialButton.type = "button";
  essentialButton.className =
    "privacy-button privacy-button-secondary";
  essentialButton.textContent =
    "Somente essenciais";

  acceptButton.type = "button";
  acceptButton.className =
    "privacy-button privacy-button-primary";
